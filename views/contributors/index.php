...
<div class="container_12">
	<div class="grid_12" style="font-size: 130%; margin: 20px 12px;">
		...
		<ol>
			...
			<li>These terms will be governed by the laws of the State of California and
			applicable U.S. Federal law.  Any choice of law rules will not apply.</li>
		</ol>
		<?php
		echo $this->Form->Open();
